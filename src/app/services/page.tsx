...
export const metadata: Metadata = {
  ...
  description: "Civil & structural engineering, energy & grid, water, transit and geotechnical services for infrastructure programs of national consequence.",
  openGraph: {
    title: "Capabilities — Boddam Infra",
    description: "Six engineering disciplines, delivered as one practice. From feasibility to handover.",
    url: "/services",
  },
};
      ...
      <section className="bg-foreground text-background">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 py-32">
          ...
          <div className="mt-20 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pt-10 border-t border-background/10">
            ...
            <Link href="/contact" className="inline-flex items-center gap-3 bg-accent px-7 py-4 text-[12px] tracking-[0.22em] uppercase text-accent-foreground hover:bg-background hover:text-foreground transition">
