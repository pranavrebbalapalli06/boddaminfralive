...
export const Route = createFileRoute("/projects")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A curated index of bridges, energy, water and transit programs engineered by Boddam Infra across India, South Asia and the Gulf." },
      { property: "og:title", content: "Selected Works — Boddam Infra" },
      { property: "og:description", content: "Bridges, solar parks, desalination blocks and metro systems — the practice's recent portfolio." },
      { property: "og:url", content: "/projects" },
      { property: "og:image", content: bridgeImg },
    ],
...
const projects = [
  { tag: "Bridge", year: "2024", title: "Kaveri Cable-Stay Crossing", loc: "Karnataka, IN", scope: "1.8 km cable-stay bridge with 320 m main span", img: bridgeImg, span: "wide" },
  { tag: "Water", year: "2023", title: "Coastal Desalination Block-04", loc: "Gujarat, IN", scope: "200 MLD SWRO desalination plant", img: waterImg, span: "tall" },
  { tag: "Energy", year: "2025", title: "Saurya 480 MW Solar Park", loc: "Rajasthan, IN", scope: "Utility-scale PV with 220 kV interconnection", img: solarImg, span: "wide" },
  { tag: "Transit", year: "2022", title: "NH-44 Elevated Viaduct Package-7", loc: "Telangana, IN", scope: "26 km segmental viaduct system", img: heroImg, span: "tall" },
  { tag: "Industrial", year: "2024", title: "Khor Fakkan Steel Terminal", loc: "Sharjah, AE", scope: "Deep-water steel handling terminal", img: steelImg, span: "wide" },
];
    ...
    <>
      ...
      <section className="bg-secondary">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 py-24 flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
          ...
          <Link to="/contact" className="inline-flex items-center gap-3 bg-foreground px-7 py-4 text-[12px] tracking-[0.22em] uppercase text-background hover:bg-accent hover:text-accent-foreground transition">
