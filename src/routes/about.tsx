...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Boddam Infra is a 240-person engineering practice delivering bridges, energy, water and transit infrastructure across three continents." },
      { property: "og:title", content: "Practice — Boddam Infra" },
      { property: "og:description", content: "Sixteen years. Forty-two programs. Three continents. Meet the engineering practice behind Boddam Infra." },
        ...
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 pb-32 grid grid-cols-1 md:grid-cols-12 gap-12">
          <Reveal className="md:col-span-7">
            <div className="aspect-[4/3] overflow-hidden bg-muted">
              <img src={aboutImg} alt="Engineer reviewing blueprints on site" className="h-full w-full object-cover" width={1600} height={1200} loading="lazy" />
            </div>
          </Reveal>
