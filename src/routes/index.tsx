...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Boddam Infra is a specialist infrastructure practice delivering bridges, energy, water and transit programs with engineering rigor and creative vision." },
      { property: "og:title", content: "Boddam Infra — Engineering the structures that move nations" },
      { property: "og:description", content: "A specialist infrastructure practice delivering bridges, energy, water and transit programs with engineering rigor." },
...
const works = [
  { tag: "Bridge / 2024", title: "Kaveri Cable-Stay Crossing", loc: "Karnataka, IN", img: bridgeImg },
  { tag: "Water / 2023", title: "Coastal Desalination Block-04", loc: "Gujarat, IN", img: waterImg },
  { tag: "Energy / 2025", title: "Saurya 480 MW Solar Park", loc: "Rajasthan, IN", img: solarImg },
];
  ...
  return (
    <>
      ...
      <section className="relative bg-foreground text-background overflow-hidden">
        <img src={steelImg} alt="" className="absolute inset-0 h-full w-full object-cover opacity-20" loading="lazy" />
        ...
        <div className="relative mx-auto max-w-[1400px] px-6 md:px-10 py-32">
          <div className="flex items-end justify-between mb-20">
            ...
            <Link to="/services" className="hidden md:inline-flex items-center gap-2 text-[12px] tracking-[0.22em] uppercase text-background/70 hover:text-accent transition">
              All capabilities →
            </Link>
          </div>
      ...
      <section className="bg-background">
        <div className="mx-auto max-w-[1400px] px-6 md:px-10 py-32">
          <div className="flex items-end justify-between mb-16">
            ...
            <Link to="/projects" className="hidden md:inline-flex items-center gap-2 text-[12px] tracking-[0.22em] uppercase text-foreground/70 hover:text-accent transition">
              Full index →
            </Link>
          </div>
