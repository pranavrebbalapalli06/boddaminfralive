...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Book a 30-minute conversation with Boddam Infra's engineering leadership. Studios in Hyderabad, Ahmedabad and Dubai." },
      { property: "og:title", content: "Contact — Book a call with Boddam Infra" },
      { property: "og:description", content: "Pick a slot. Bring a brief. We'll bring the right team." },
